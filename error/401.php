        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="text-center">
                    ...
                    <p class="lead">Vous n'êtes pas autorisé à accéder à cette ressource. Veuillez vous connecter ou contacter l'administrateur du site pour obtenir l'autorisation.</p>
