...
<body class="bg-light d-flex justify-content-center align-items-center vh-100">
    <div class="container bg-white p-5 rounded shadow text-center" style="max-width: 400px;">
        <h1 class="display-1 text-dark">401</h1>
        <h2 class="mb-4">Non autorisé</h2>
        <p class="lead text-secondary">Vous devez être authentifié pour accéder à cette ressource. Veuillez vous connecter et réessayer.</p>
