...
<head>
    ...
    <title>502 Mauvaise passerelle</title>
...
<body class="bg-light d-flex justify-content-center align-items-center vh-100">
    <div class="container bg-white p-5 rounded shadow text-center" style="max-width: 400px;">
        <h1 class="display-1 text-dark">502</h1>
        <h2 class="mb-4">Mauvaise passerelle</h2>
        <p class="lead text-secondary">Le serveur a reçu une réponse invalide d'un serveur en amont.</p>
