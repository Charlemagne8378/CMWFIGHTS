...
<head>
    ...
    <title>408 Requête expirée</title>
...
<body class="bg-light d-flex justify-content-center align-items-center vh-100">
    <div class="container bg-white p-5 rounded shadow text-center" style="max-width: 400px;">
        <h1 class="display-1 text-dark">408</h1>
        <h2 class="mb-4">Requête expirée</h2>
        <p class="lead text-secondary">La requête a pris trop de temps à être complétée. Veuillez réessayer.</p>
