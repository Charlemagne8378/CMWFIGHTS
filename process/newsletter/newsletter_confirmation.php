...
<div class="container mt-5">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <p class="card-text">Date d'envoi : <?= $date_envoi ?></p>
            <a href="newsletter_edit.php?id=<?= $newsletter['id'] ?>" class="btn btn-secondary">Modifier</a>
            ...
            <form action="send_newsletter.php" method="post" style="display:inline;">
                ...
                <input type="hidden" name="title" value="<?= htmlspecialchars($newsletter['titre']) ?>">
                <input type="hidden" name="subject" value="<?= htmlspecialchars($newsletter['sujet']) ?>">
