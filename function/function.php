...
function sendEmail($to, $subject, $content)
{
    ...
    try {
        ...
        $message .= '<a href="https://www.tiktok.com/@cmwfight?'.time().'" target="_blank"><img src="https://www.cmwfight.fr/Images/icon-rs/tiktok_icons.png?'.time().'" alt="TikTok" width="32" style="margin: 0 10px;"></a>';
        $message .= '<a href="https://www.instagram.com/cmwfight/?'.time().'" target="_blank"><img src="https://www.cmwfight.fr/Images/icon-rs/instagram_icons.png?'.time().'" alt="Instagram" width="32" style="margin: 0 10px;"></a>';
        $message .= '<a href="https://www.youtube.com/@CMWFIGHT?'.time().'" target="_blank"><img src="https://www.cmwfight.fr/Images/icon-rs/youtube_icons.png?'.time().'" alt="YouTube" width="32" style="margin: 0 10px;"></a>';
        $message .= '</div>';
