...
// Récupération des newsletters envoyées
...
// Récupération des newsletters programmées
$page_programmed = isset($_GET['page_programmed']) ? (int)$_GET['page_programmed'] : 1;
$offset_programmed = ($page_programmed - 1) * $limit;
$query_programmed = $pdo->prepare("SELECT * FROM NEWSLETTERS WHERE statut = 'programmé' LIMIT :limit OFFSET :offset");
$query_programmed->bindParam(':limit', $limit, PDO::PARAM_INT);
$query_programmed->bindParam(':offset', $offset_programmed, PDO::PARAM_INT);
$query_programmed->execute();
$programmed_newsletters = $query_programmed->fetchAll(PDO::FETCH_ASSOC);
$total_programmed = $pdo->query("SELECT COUNT(*) FROM NEWSLETTERS WHERE statut = 'programmé'")->fetchColumn();

// Récupération des utilisateurs inscrits à la newsletter
...
<div class="container mt-5">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="../process/newsletter/newsletter_confirmation.php?id=<?= $draft['id'] ?>" class="btn btn-success btn-sm">Envoyer</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="../process/newsletter/newsletter_view.php?id=<?= $newsletter['id'] ?>" class="btn btn-info btn-sm">Voir</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
    ...
    <div class="card mb-4">
        <div class="card-header">Newsletters programmées</div>
        <div class="card-body">
            <table class="table table-bordered">
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php foreach ($programmed_newsletters as $programmed): ?>
                    <tr>
                        <td><?= htmlspecialchars($programmed['titre']) ?></td>
                        <td><?= htmlspecialchars($programmed['date_programmation']) ?></td>
                        <td>
                            <a href="../process/newsletter/newsletter_edit.php?id=<?= $programmed['id'] ?>" class="btn btn-warning btn-sm">Modifier</a>
                            <a href="../process/newsletter/newsletter_delete.php?id=<?= $programmed['id'] ?>" class="btn btn-danger btn-sm">Supprimer</a>
                            <a href="../process/newsletter/newsletter_confirmation.php?id=<?= $programmed['id'] ?>" class="btn btn-success btn-sm">Envoyer</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
            <?php renderPagination($total_programmed, $limit, $page_programmed, 'page_programmed'); ?>
        </div>
    </div>
    <div class="card mb-4">
